            ...
            @foreach ($teachers as $teacher)
                <div class="flex flex-wrap items-center text-gray-700 border-t-2 border-l-4 border-r-4 border-gray-300">
                    ...
                    <div class="w-3/12 flex items-center justify-end px-3">
                        <a href="{{ route('teacher.show',$teacher) }}" class="ml-1 bg-gray-600 block p-1 border border-gray-600 rounded-sm" title="assign subject">
                        ...
                        <a href="{{ route('teacher.destroy', $teacher) }}" data-url="{{ route('teacher.destroy', $teacher->id) }}" class="deletebtn ml-1 bg-gray-600 block p-1 border border-gray-600 rounded-sm">
