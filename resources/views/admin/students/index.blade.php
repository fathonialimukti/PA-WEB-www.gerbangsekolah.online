...
@section('content')
    <div class="roles-permissions">
        <div class="flex items-center justify-between mb-6">
            <div>
                <h2 class="text-gray-700 uppercase font-bold">Daftar Pelajar</h2>
            </div>
            <div class="flex flex-wrap items-center">
                <a href="{{ route('student.create') }}" class="bg-gray-200 text-gray-700 text-sm uppercase py-2 px-4 flex items-center rounded">
                    ...
                    <span class="ml-2 text-xs font-semibold">Buat Akun Pelajar</span>
                </a>
            </div>
        </div>
        <div class="mt-8 bg-white rounded border-b-4 border-gray-300">
            <div class="flex flex-wrap items-center uppercase text-sm font-semibold bg-gray-300 text-gray-600 rounded-tl rounded-tr">
                ...
                <div class="w-2/12 px-4 py-3">HP</div>
            ...
            @foreach ($students as $student)
                <div class="flex flex-wrap items-center text-gray-700 border-t-2 border-l-4 border-r-4 border-gray-300">
                    ...
                    <div class="w-2/12 px-4 py-3 text-sm font-semibold text-gray-600 tracking-tight">{{ $student->grade->class_name ?? '' }}</div>
                    ...
                    <div class="w-2/12 flex items-center justify-end px-3">
                        ...
                        <form action="{{ route('student.destroy',$student->id) }}" id="delete-student" method="POST" class="inline-flex ml-1" >
                            @csrf
                            @method('DELETE')
                            <button type="button" class="bg-gray-600 block p-1 border border-gray-600 rounded-sm delete-confirm delete" onclick="deleteConfirm('delete-student','{{$student->user->name}}')">
        ...
        @include('admin.modals.delete',['name' => 'student'])
    </div>
@endsection
