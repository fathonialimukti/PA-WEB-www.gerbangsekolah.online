<div class="w-full md:w-1/6 bg-gray-200 md:bg-gray-200 px-2 text-center fixed bottom-0 md:pt-0 md:top-0 md:left-0 h-10 md:h-screen">
   ...
   <div class="md:mb-6 md:mt-20 px-6">
      ...
      <ul class="list-reset flex flex-row md:flex-col text-center md:text-left">
         ...
         {{-- All User --}}
         <li class="flex-1">
            <a href="{{ route('home') }}" class="flex justify-center md:justify-start text-gray-600 py-2 hover:text-blue-700">
               <svg class="h-4 w-4 fill-current feather feather-grid" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                  <path d="M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z" />
                </svg>
               <span class="hidden sm:block ml-2 text-sm font-semibold">Halaman Utama</span>
           </a>
         </li>

         @role('Admin')
         <li class="flex-1">
            <a href="{{ route('teacher.index') }}" class="flex justify-center md:justify-start text-gray-600 py-2 hover:text-blue-700">
               <svg class="h-4 w-4 fill-current" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="user-edit" class=" content-center svg-inline--fa fa-user-edit fa-w-20" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><path fill="currentColor" d="M224 256c70.7 0 128-57.3 128-128S294.7 0 224 0 96 57.3 96 128s57.3 128 128 128zm89.6 32h-16.7c-22.2 10.2-46.9 16-72.9 16s-50.6-5.8-72.9-16h-16.7C60.2 288 0 348.2 0 422.4V464c0 26.5 21.5 48 48 48h274.9c-2.4-6.8-3.4-14-2.6-21.3l6.8-60.9 1.2-11.1 7.9-7.9 77.3-77.3c-24.5-27.7-60-45.5-99.9-45.5zm45.3 145.3l-6.8 61c-1.1 10.2 7.5 18.8 17.6 17.6l60.9-6.8 137.9-137.9-71.7-71.7-137.9 137.8zM633 268.9L595.1 231c-9.3-9.3-24.5-9.3-33.8 0l-37.8 37.8-4.1 4.1 71.8 71.7 41.8-41.8c9.3-9.4 9.3-24.5 0-33.9z"></path></svg>
               <span class="hidden sm:block ml-2 text-sm font-semibold">Daftar Guru</span>
           </a>
         </li>
         <li class="flex-1">
            <a href="{{ route('grade.index') }}" class="flex justify-center md:justify-start text-gray-600 py-2 hover:text-blue-700">
               ...
               <span class="hidden sm:block ml-2 text-sm font-semibold">Daftar Kelas</span>
           </a>
         </li>
         <li class="flex-1">
            <a href="{{ route('student.index') }}" class="flex justify-center md:justify-start ustify-center text-gray-600 py-2 hover:text-blue-700">
               ...
               <span class="hidden sm:block ml-2 text-sm font-semibold">Daftar Murid</span>
           </a>
         </li>
         {{-- <li class="flex-1">
            <a href="{{ route('attendance.index') }}" class="flex justify-center md:justify-start text-gray-600 py-2 hover:text-blue-700">
               ...
               <span class="hidden sm:block ml-2 text-sm font-semibold">Attendance</span>
           </a>
         </li> --}}
         {{-- <li class="flex-1">
            <a href="{{ route('assignrole.index') }}" class="flex justify-center md:justify-start text-gray-600 py-2 hover:text-blue-700">
               ...
               <span class="hidden sm:block ml-2 text-sm font-semibold">Assign Role</span>
           </a>
         </li>
         <li class="flex-1">
            <a href="{{ route('roles-permissions') }}" class="flex justify-center md:justify-start text-gray-600 py-2 hover:text-blue-700">
               ...
               <span class="hidden sm:block ml-2 text-sm font-semibold">Roles &amp; Permissions</span>
           </a>
         </li> --}}
         @endrole
         ...
         @role('Teacher')
         <li class="flex-1">
            <a href="{{ route('assignment-manager.index') }}" class="flex justify-center md:justify-start text-gray-600 py-2 hover:text-blue-700">
               ...
               <span class="hidden sm:block ml-2 text-sm font-semibold">Daftar Tugas</span>
           </a>
         </li>
         @endrole
         ...
         @role('Student')
         <li class="flex-1">
            <a href="{{ route('assignment.student') }}" class="flex justify-center md:justify-start text-gray-600 py-2 hover:text-blue-700">
               <svg class="h-4 w-4 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                  <path d="M9 2a2 2 0 00-2 2v8a2 2 0 002 2h6a2 2 0 002-2V6.414A2 2 0 0016.414 5L14 2.586A2 2 0 0012.586 2H9z" />
                  <path d="M3 8a2 2 0 012-2v10h8a2 2 0 01-2 2H5a2 2 0 01-2-2V8z" />
                </svg>
