      ...
      <ul class="list-reset flex flex-row md:flex-col text-center md:text-left">
         ...
         <li class="flex-1">
            <a href="{{ route('home') }}" class="flex justify-center md:justify-start text-gray-600 py-2 hover:text-blue-700">
               ...
               <span class="hidden sm:block ml-2 text-sm font-semibold">Dashboard</span>
           </a>
         </li>
         ...
         <li class="flex-1">
            <a href="{{ route('teacher.index') }}" class="flex justify-center md:justify-start text-gray-600 py-2 hover:text-blue-700">
               ...
               <span class="hidden sm:block ml-2 text-sm font-semibold">Teachers</span>
           </a>
         </li>
         <li class="flex-1">
            <a href="{{ route('grade.index') }}" class="flex justify-center md:justify-start text-gray-600 py-2 hover:text-blue-700">
               ...
               <span class="hidden sm:block ml-2 text-sm font-semibold">Classes</span>
           </a>
         </li>
         <li class="flex-1">
            <a href="{{ route('student.index') }}" class="flex justify-center md:justify-start ustify-center text-gray-600 py-2 hover:text-blue-700">
               ...
               <span class="hidden sm:block ml-2 text-sm font-semibold">Students</span>
           </a>
         </li>
         {{-- <li class="flex-1">
         ...
         <li class="flex-1">
            <a href="{{ route('assignment-manager.index') }}" class="flex justify-center md:justify-start text-gray-600 py-2 hover:text-blue-700">
               ...
               <span class="hidden sm:block ml-2 text-sm font-semibold">Manajemen Tugas</span>
           </a>
         </li>
         @endrole
