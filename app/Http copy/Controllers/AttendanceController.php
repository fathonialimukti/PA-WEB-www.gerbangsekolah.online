...
class AttendanceController extends Controller
{
    ...
    public function index()
    {
        ...
        if( request()->has(['type', 'month']) ) {
            ...
            if($type == 'class') {
                ...
                return view('admin.attendance.index', compact('attendances','months'));
    ...
    {
        $class = Grade::with(['students','teacher'])->findOrFail($classid);

        return view('admin.attendance.create', compact('class'));
    }
    ...
    public function show(Attendance $attendance)
    {
        ...
        return view('admin.attendance.show', compact('attendances'));
    }
